...
class CreateIncidentParams(BaseModel):
    ...
    u_area: Optional[str] = Field(None, description="Network area identifier (string)")
    u_kpi_rsrp: Optional[str] = Field(None, description="KPI - Reference Signal Received Power in dBm (string, e.g. '-85.0')")
    u_kpi_sinr: Optional[str] = Field(None, description="KPI - Signal to Interference plus Noise Ratio in dB (string, e.g. '5.0')")
    u_kpi_rsrq: Optional[str] = Field(None, description="KPI - Reference Signal Received Quality in dB (string, e.g. '-10.0')")
    u_packet_loss: Optional[str] = Field(None, description="Packet loss percentage (string, e.g. '2.5')")
    u_drop_rate: Optional[str] = Field(None, description="Call drop rate percentage (string, e.g. '1.2')")
    u_throughput_dl_mbps: Optional[str] = Field(None, description="Downlink throughput in Mbps (string, e.g. '100.5')")
    u_throughput_ul_mbps: Optional[str] = Field(None, description="Uplink throughput in Mbps (string, e.g. '50.3')")
    u_case_type: Optional[str] = Field(None, description="Case type classification (string)")
